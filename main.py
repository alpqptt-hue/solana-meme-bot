...
def send_hourly_report():
    ...
    if 7 <= current_utc_hour < 15:
        current_session = "آسيا / لندن (Asia / London)"
    elif 15 <= current_utc_hour < 22:
        current_session = "نيويورك (New York)"
    else:
        current_session = "سيدني / آسيا المبكرة (Sydney / Early Asia)"
        
    report = (
        f"📊 *التقرير الساعي لبوت قنص الميم كوين*\n"
        f"-----------------------------------\n"
        f"🌐 *الجلسة النشطة:* `{current_session}`\n"
...
if __name__ == "__main__":
    ...
    welcome_msg = (
        "🚀 *تم تشغيل بوت قنص الميم كوين (مع دعم الجلسة النشطة) بنجاح!*\n"
        "⚡ *المميزات:* مسح متوازي سريع للبيانات، نظام الجلسات، الحفظ الآمن."
    )
